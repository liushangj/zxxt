    ...
    <div class=""  v-loading="isLoading">
        <div class="_container_ m0auto pb200">
            ...
            <div class="clearfix pb37 bbeee search">
                <el-input
                        class="fl w430 bgf5_input "
                        placeholder="输入姓名搜索"
                        suffix-icon="iconfont icon-sousuo"
                        v-model="sea_key">
                </el-input>
                <!--<ButtonIcon text="守约中" icon="icon-jt" class="fr be5 "></ButtonIcon>-->
                <el-select v-model="ispro" placeholder="请选择" class="fr w120 search_select ml16 h49 bgf5_input">
                    <el-option
                ...
                <div class="fr fs14 c999 be5 ml16 pl18 lh45 mediaw25p">
                    <span class="disinblock">守约次数</span>
                    <el-select v-model="pronum" placeholder="请选择" class="fr w120 search_select bnone bgf5_input">
                        <el-option
                ...
                <div class="fr fs14 c999 be5 ml16 pl18 pr30 bgf5_input">
            ...
            <ul class="fs14 pb76" >
                <li v-for="(v,k) in logs" :key="k">
                    <TableTr :logs="v" :status="0"></TableTr>
                </li>
            </ul>
    ...
    export default {
        ...
        methods:{
            getInfo(){
                //
                this.isLoading = true;
                this.$axios.post('/auth/internal_base').then((res) => {
                    res = res.data;
                    console.log(res);
                    if(res.status == 1) {
                        ...
                        this.$message.error(res.msg || '查询失败，请稍后再试！');
                    }
                }).catch((err)=>{
...
<style>
    ...
    .bnone.el-select .el-input.is-focus .el-input__inner{
        border-color:#fff ;
    }
